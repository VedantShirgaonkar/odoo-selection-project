...
const ItemListing = () => {
  ...
  const types = ['Men', 'Women', 'Unisex', 'Kids', 'Other'];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <button className="p-2 hover:bg-slate-100 rounded-lg transition-colors" onClick={() => navigate(-1)}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 px-6 py-3 bg-gradient-to-r from-violet-500 to-coral-500 text-white rounded-xl hover:from-violet-600 hover:to-coral-600 transition-all transform hover:scale-105 flex items-center justify-center space-x-2 disabled:opacity-60"
                disabled={loading}
              >
                <Save className="w-5 h-5" />
                <span>{loading ? 'Listing...' : 'List Item'}</span>
              </button>
            </div>
            {error && <div className="text-red-500 mt-2 text-sm">{error}</div>}
            {success && <div className="text-green-600 mt-2 text-sm">Item listed! Redirecting...</div>}
          </div>
        </div>
      </div>
    </div>
